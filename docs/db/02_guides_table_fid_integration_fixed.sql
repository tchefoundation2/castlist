-- =====================================================
-- Castlist Database Schema: Guides Table with FID Integration (FIXED)
-- =====================================================
-- 
-- This script creates the guides table and integrates it with
-- the FID-based user system. FIXED for existing bigint IDs.
--
-- Run this script AFTER 01_profiles_table_fid.sql
-- =====================================================

-- 1. Create guides table (using BIGINT for compatibility)
...
-- 2. Create books table (using BIGINT for compatibility)
...
-- 3. Create guide_books junction table (using BIGINT)
...
-- 4. Create activities table for social features (using BIGINT)
...
-- 5. Create guide_likes table for social interactions (using BIGINT)
...
-- =====================================================
-- 
-- 1. FIXED: Changed all UUIDs to BIGINT/BIGSERIAL for compatibility
