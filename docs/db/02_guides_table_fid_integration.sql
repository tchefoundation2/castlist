-- =====================================================
-- Castlist Database Schema: Guides Table with FID Integration
-- =====================================================
-- 
-- This script creates the guides table and integrates it with
-- the FID-based user system.
--
...
-- 3. Create guide_books junction table (many-to-many)
...
-- 4. Create activities table for social features
...
-- 5. Create guide_likes table for social interactions
...
-- 10. RLS Policies for books (public read, authenticated write)
...
-- 11. RLS Policies for guide_books
...
-- 12. RLS Policies for activities (public read, own write)
...
-- 13. RLS Policies for guide_likes
...
-- =====================================================
-- 
-- 1. All tables are integrated with the FID-based user system
-- 2. RLS policies ensure data security and proper access control
-- 3. The social features (likes, activities) are ready for implementation
-- 4. Remember to set app.current_user_fid in your application code
-- 5. Consider adding more social features (comments, follows, etc.)
--
-- =====================================================
